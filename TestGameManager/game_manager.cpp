...
namespace TestGameManager_098765432_123456789 {

using namespace UserCommon_098765432_123456789;

TestGameManager::TestGameManager(bool verbose)
    : m_currentStep(0),
      m_gameOver(false),
...
bool TestGameManager::readBoard(const SatelliteView& satellite_view, size_t map_width, size_t map_height, 
...
bool TestGameManager::saveResults(Player& player1, Player& player2) {
...
void TestGameManager::processStep() {
...
void TestGameManager::applyAction(TankWithAlgorithm& controller) {
...
void TestGameManager::moveShellsOnce() {
...
void TestGameManager::populateGameResult(int winner, GameResult::Reason reason, const std::vector<size_t>& remainingTanks) {
...
std::string TestGameManager::logAction() {
...
std::string TestGameManager::actionToString(ActionRequest action) {
    switch (action) {
...
Direction TestGameManager::getInitialDirection(int playerId) {
...
void TestGameManager::createTanks(const std::vector<std::pair<int, Point>>& tankPositions) {
...
bool TestGameManager::saveErrorsToFile(
...
void TestGameManager::removeDestroyedShells() {
  m_shells.erase(
...
void TestGameManager::createTankAlgorithms(TankAlgorithmFactory player1_factory, TankAlgorithmFactory player2_factory) {
...
std::string TestGameManager::generateOutputFilePath(const std::string& player1Name, const std::string& player2Name) {
...
std::string TestGameManager::cleanFilename(const std::string& name) {
...
std::vector<std::string> TestGameManager::readSatelliteView(const SatelliteView& satellite_view, 
                                                       size_t map_width, 
...
using namespace TestGameManager_098765432_123456789;
REGISTER_GAME_MANAGER(TestGameManager);
