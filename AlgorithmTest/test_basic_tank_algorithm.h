 ...
 */
class TestBasicTankAlgorithm : public TankAlgorithm {
public:
    /**
     * @brief Constructor
     * 
     ...
     */
    TestBasicTankAlgorithm(int playerId, int tankIndex);
    /**
     * @brief Destructor
     */
    ~TestBasicTankAlgorithm() override;
