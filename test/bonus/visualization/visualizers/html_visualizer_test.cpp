...
protected:
    ...
    GameSnapshot createTestSnapshot(int step) {
        ...
        return GameSnapshot(step, board, tanks, shells, "Test snapshot " + std::to_string(step));
    }
...
<body>
    ...
    const std::string cssTemplate = "body { font-family: sans-serif; }";
